...
export default function Home() {
  ...
  const getWeatherData=async ()=>{
    //https://api.openweathermap.org/data/2.5/weather?q=pune&appid=WEATHER_API_KEY
  ...
  return (
   ...
   <div className={styles.outerdiv}>
     <Head>
        <title>Weather App</title> {/* Setting the page title to Weather App */}
        <meta name="description" content="Weather App - Check live weather updates" />
      </Head>
   ...
   placeData && <div className={styles.row}>
    <div className={styles.section1}>
      ...
      <div className={styles.timediv}>
        ...
        <p className={styles.date}>{currentDay}</p> {/* Display the current day and date */}
